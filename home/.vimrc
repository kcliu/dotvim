...
set fileencodings=utf-8,big5,ascii,latin1
...
set directory=$HOME/.vim/.tmp,~/tmp,/tmp
...
inoremap neocomplcache#smart_close_popup() . (&indentexpr != '' ? "<C-f><CR>X<BS>":"<CR>")
" <TAB>: completion. 
